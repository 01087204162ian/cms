...
<head>
	...
	<script src="./js/DaeriMemberNotJumin.js" type="text/javascript"></script><!--ajax-->
		  ...
		  <input type='hidden' id='userId' value='<?=$userId?>' />
			...
			<input type='hidden' id='policyNum' value='<?=$policyNum?>' />
				   ...
				   switch($gita){
					...
					<tr>
						<td colspan='2'><span id='company' /></td>
						<td colspan='4'>배서기준일<?include '../php/customer_endorse_day_lig.php';?>
