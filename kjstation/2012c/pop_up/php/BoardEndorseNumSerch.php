...
$en_sql="SELECT max(num) as max_num FROM 2021EndorseList WHERE 2012DaeriCompanyNum='$DaeriCompanyNum' ";
$en_sql.="and CertiTableNum='$CertiTableNum'";
	...
	$p_sql="SELECT pnum,sangtae,endorse_day,ch FROM 2021EndorseList WHERE num='$maxnum'";
	//echo "p_sql $p_sql <br>";
