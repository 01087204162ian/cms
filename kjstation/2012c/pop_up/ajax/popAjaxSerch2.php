...
if($jumin){ // 주민번호로 조회 할때 num 값이 필요 
	...
	$a[15]=$row[notJumin];  // 값이 1이면 주민번호 입력없이 운전자 추가 가능 2022-10-11
...
echo"<data>\n";
	...
	//증권번호 조회를 위하여 ...
	$certiSql="SELECT * FROM 2012CertiTable WHERE 2012DaeriCompanyNum='$num' and InsuraneCompany='$com' and startyDay>='$yearbefore' and control='1'"; //대리운전회사에 운전자 추가 할 수 있는 경우만
	//control 2이면 추가 불가
