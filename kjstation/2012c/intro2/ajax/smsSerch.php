...
include '../../../dbcon.php';
	...
	if($s_contents){
		...
		$where="where Rphone1='$Rphone[0]' and Rphone2='$Rphone[1]' and Rphone3='$Rphone[2]' and (SendName='drive'  or SendName='preminum') and dagun='1' order by SeqNo desc";
	}else{
		$where="WHERE LastTime>='$sigi' and LastTime<='$end' and (SendName='drive'  or SendName='preminum')  order by SeqNo desc";
	}
