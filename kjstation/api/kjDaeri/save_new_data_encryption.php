<?php
/**
 * 보험료 데이터 저장 API - FormData 처리 버전 (테스트용)
 * PHP 4.4.9 버전 호환
 */
...
foreach ($endorseData as $member) {
    ...
    $insertSql .= "Name, Jumin, nai, push, etag, Hphone, InPutDay, wdate, dongbuCerti,JuminHash)";
    $insertSql .= "VALUES ('$dNum', '$InsuraneCompany', '$cNum', '$name', ";
    $insertSql .= "'$encryptedJumin', '$age', '4', '$gita', '$encryptedPhone', now(), now(), '$policyNum','$jumin_hash')";
