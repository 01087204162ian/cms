...
for ($i = 0; $i < count($data); $i++) {
    ...
    // SQL 인젝션 방지
    $certi = mysql_escape_string($item['certi']);
    ...
    // 기존 데이터 확인
    $checkQuery = "SELECT id FROM kj_insurance_premium_data WHERE policyNum = '$certi' AND rowNum = $rowNum LIMIT 1";
    ...
    if (mysql_num_rows($checkResult) > 0) {
        ...
        $updateQuery = "UPDATE kj_insurance_premium_data SET 
