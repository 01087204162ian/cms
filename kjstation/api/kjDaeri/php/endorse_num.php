...
//배서 번호를 찾기위해
$en_sql = "SELECT max(num) as max_num FROM `2012EndorseList` WHERE 2012DaeriCompanyNum='$dNum' ";
$en_sql .= "and CertiTableNum='$cNum'";
//echo "en $en_sql <br>";
$res = mysql_query($en_sql, $conn);
