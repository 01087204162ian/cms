...
function koimaSele(k){
	...
	/*일일 버튼 */
		...
		// bButton.style.width = '300px';
		 ...
		 bButton.onclick=koima;
	
}

function koima(){//대리운전회사 기본정보
	...
	if(ssang_c_num){
		...
		window.open('../pop_up/koima.php?num='+ssang_c_num+'&Pcompany='+Pcompany,'new_Union','left='+winl+',top='+wint+',resizable=yes,width=930,height=540,scrollbars=yes,status=yes')
	}else{
		alert('조회 후 !!');
		return false;
	}
