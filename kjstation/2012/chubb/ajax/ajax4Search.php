...
include '../../../dbcon.php';
	...
	switch($gi){
		...
		$sql="Select num,kibs_list_num,policy,invoice,vessel,sigi,wdate,useruid ";	
		$sql.="FROM kibs_list_noclaim $where";
...
echo"<data>\n";
	...
	for($k=0;$k<$last;$k++){
			...
			$policy  = mysql_result($result2,$count,"policy");
			$invoice  = mysql_result($result2,$count,"invoice");
			$vessel  = mysql_result($result2,$count,"vessel");
