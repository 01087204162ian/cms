...
$row_2=mysql_fetch_array($rs_2);
   ...
   // 기존 pdf파일의 경로를 설정 
   $pdf->setSourceFile('../../../../kibs_admin/consulting/print/cancel.pdf'); 
   ...
   $data[com_eur_name] = $row_2['com_eur_name'];
   $data[cancel_certi] = $row['cancel_certi'];
   $data[new_certi] = $row['new_certi'];
   $data[reason] =chop($row['reason']);
 
    
    
   // 템플릿 파일명  
   $tpl_file = "../../../../kibs_admin/consulting/print/cancel.frm"; 
