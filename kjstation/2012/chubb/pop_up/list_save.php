...
//echo "con $con_name <br>";
//return false;
$sql="SELECT num FROM kibs_list WHERE com_name='$com_name'";
...
$os_rs = mysql_query($sql1,$connect);
	...
	$dbinsert = "insert into kibs_list ";
	$dbinsert .= "values('','$contents','$product','$postnum','$address1','$address_2','$com_name','$com_eur_name','$com_number','$com_number_2',";
	$dbinsert .= "'$name_1','$phone_1','$fax_1','$mail_1','$name_2','$phone_2','$fax_2','$mail_2','$name_3','$phone_3','$fax_3','$mail_3', ";
	$dbinsert .= "'$name_4','$phone_4','$fax_4','$mail_4','$name_5','$phone_5','$fax_5','$mail_5','$name_6','$phone_6','$fax_6','$mail_6', ";
	$dbinsert .= "'$item_1','$item_2','$item_3','$giro_1','$insurance_name','$bank_name','$bank_number','$company_name','$content',now(), ";
	$dbinsert .= "'$userid','$sigi','$jeonggi','$check_1','$delivery','$young_su','$list','$messenger_1','$messenger_2','$messenger_3', ";
	$dbinsert .= "'$messenger_4','$messenger_5','$messenger_6','$cord','$harin','$forwarder', ";
	$dbinsert .="'$job_1','$job_2','$job_3','$job_4','$job_5','$job_6')";
	//echo"$dbinsert <br> ";
