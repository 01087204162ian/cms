...
function inWonTotal(){
    ...
    var winl = (screen.width - 1024) / 2
	var wint = (screen.height - 768) / 2
	window.open('../pop_up/boardDaeriList.php?DaeriCompanyNum='+num,'allDriverMember','left='+winl+',top='+wint+',resizable=yes,width=960,height=800,scrollbars=yes,status=yes')
	}else{
