...
<input type='hidden' id='userId' name='userId' value='<?=$userId?>'>
  ...
  //if( $userId=='kibs7383'){?>
   <table>
	  ...
	  <tr> <? for($__k=1;$__k<10;$__k++){
			if($__k==9){$InsCom[$__k]='계';}
		    ?>
...
<?// if($userId=='kibs0327'){?> <!--  <li><input type="button" class="btn-b" style="cursor:hand;width:80;"  value="정리"  onFocus='this.blur()'      onClick="jeongLi()"></li>--><?//}?>
   <li><input type="button" class="btn-b" style="cursor:hand;width:80;"  value="동부신규"  onFocus='this.blur()'      onClick="dongbuS()"></li>
   <li><input type="button" class="btn-b" style="cursor:hand;width:80;"  value="일반"  onFocus='this.blur()'      onClick="ilban()"></li>
   <li><input type="button" class="btn-b" style="cursor:hand;width:80;"  value="코드"  onFocus='this.blur()'      onClick="cord()"></li>
   <li><input type="button" class="btn-b" style="cursor:hand;width:80;"  value="업무"  onFocus='this.blur()'      onClick="gasi()"></li>
