...
include '../../../dbcon.php';
	...
	$sql="SELECT  *  FROM 2021CertiTable a left join 2012DaeriCompany  b ";
	$sql.="ON a.2012DaeriCompanyNum = b.num $where ";
	//$sql="Select * FROM 2012DaeriCompany   $where ";
...
echo"<data>\n";
	...
	for($k=$count;$k<$last;$k++){
	   $a[1]=mysql_result($result2,$count,"2012DaeriCompanyNum");

	   //대리기사 인원을 구하기 위해 
		$mSql="SELECT * FROM 2021DaeriMember  WHERE 2012DaeriCompanyNum='$a[1]' and push='4'";
