...
function dSerch(){
	...
	var u_id=document.getElementById("driver_num"+ab).value;
		var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		window.open('./pop_up/drive.php?num='+u_id,'Union','left='+winl+',top='+wint+',resizable=yes,width=950,height=550,scrollbars=yes,status=yes')
...
function admin_open4(){
		...
		var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		window.open('./pop_up/drive.php?new=1','new_Union','left='+winl+',top='+wint+',resizable=yes,width=930,height=540,scrollbars=no,status=yes')
}
...
function ssV(){
	...
	var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		window.open('./pop_up/compCerti.php?','ssdev','left='+winl+',top='+wint+',resizable=yes,width=930,height=540,scrollbars=no,status=yes')
...
function pV(){
	...
	var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		window.open('./pop_up/preminum.php?','psdev','left='+winl+',top='+wint+',resizable=yes,width=930,height=540,scrollbars=yes,status=yes')
