...
include '../../../dbcon.php';
	...
	$eSql="SELECT * FROM 2021CertiTable WHERE num='$CertiTableNum'";
	...
	//나이구분하여 찾기
		$nSql="SELECT * FROM 2021Cpreminum WHERE DaeriCompanyNum='$DaeriCompanyNum' and CertiTableNum='$CertiTableNum' and InsuraneCompany='$InsuraneCompany' order by sunso  asc";
