...
if($num){//대리운전 회사가 이미 등록 되어 있다고 하면 update;
	$sql="SELECT * FROM 2012koima  WHERE num='$num'";
}
if($jumin){

	$sql="SELECT * FROM 2012koima  WHERE jumin='$jumin'";
}
...
/*
	...
	/*	$iSql="SELECT * FROM 2012Costomer WHERE 2012koima Num='$num'";
...
/*	//증권번호 조회를 위하여 ...
	$certiSql="SELECT * FROM 2012CertiTable WHERE 2012koima Num='$num' and startyDay>='$yearbefore'";
	//$certiSql="SELECT * FROM 2012CertiTable WHERE 2012koima Num='$num' ";
