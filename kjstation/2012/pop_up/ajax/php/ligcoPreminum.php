...
//echo "S $Sql <br>";
	...
	$mSql="SELECT num FROM 2012DaeriMember    WHERE nai<'26'  ";
	...
	$mSql="SELECT num FROM 2012DaeriMember  WHERE nai>='26' and nai<='30' ";
	$mSql.="and 2012DaeriCompanyNum='$DaeriCompanyNum' and CertiTableNum='$num' and push='4'";
	$m2rs=mysql_query($mSql,$connect);
	$inwon[1]=mysql_num_rows($m2rs);

	$mSql="SELECT num FROM 2012DaeriMember   WHERE nai>='31' and nai<='44' ";
	$mSql.="and 2012DaeriCompanyNum='$DaeriCompanyNum' and CertiTableNum='$num' and push='4'";
	...
	$mSql="SELECT num FROM 2012DaeriMember   WHERE nai>='45' and nai<='49' ";
	$mSql.="and 2012DaeriCompanyNum='$DaeriCompanyNum' and CertiTableNum='$num' and push='4'";
	$m3rs=mysql_query($mSql,$connect);
	$inwon[3]=mysql_num_rows($m3rs);


	$mSql="SELECT num FROM 2012DaeriMember WHERE nai>='50'  ";
	$mSql.="and 2012DaeriCompanyNum='$DaeriCompanyNum' and CertiTableNum='$num' and push='4'";
	$m3rs=mysql_query($mSql,$connect);
	$inwon[4]=mysql_num_rows($m3rs);
...
$InsuP=($InsuP1+$InsuP2);
   ...
   include "./php/monthDay.php";//일일보험료 산출 하기우해
		...
		if($row[yearP1]>0){
			...
			echo "<P25P>".number_format($monthsP[0])."</P25P>\n";
			echo "<P26P>".number_format($monthsP[1])."</P26P>\n";
			echo "<P31P>".number_format($monthsP[2])."</P31P>\n";
			echo "<P45P>".number_format($monthsP[3])."</P45P>\n";
