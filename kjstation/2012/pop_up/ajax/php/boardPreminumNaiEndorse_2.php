...
switch($Dsangte){
		...
		case 2 :		//배서 처리 된 경우에 2012EndorsePreminum 에서 보험료 조회 하자
			...
			$Esql="SELECT * FROM SMSData WHERE 2021DaeriMemberNum='$e[3]' and endorse_num='$eNum'";
			//echo "ESQ l $Esql <Br>";
