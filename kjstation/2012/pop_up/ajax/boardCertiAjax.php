...
if($certiNum){//증권번호 있다면  update;
	...
	$sql="INSERT INTO 2021CertiTable  (2012DaeriCompanyNum,InsuraneCompany,startyDay,policyNum,nabang,nabang_1 )";
	...
	$ksql="SELECT num FROM 2021CertiTable  WHERE policyNum='$a[4]' and 2012DaeriCompanyNum='$a[1]'";
