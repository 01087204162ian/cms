...
if($endorseDay){//대리운전 회사가 이미 등록 되어 있다고 하면 update;
	...
	$sql="UPDATE 2021EndorseList  SET ";
	...
	$msql="SELECT * FROM 2021DaeriMember  WHERE CertiTableNum ='$CertiTableNum' and EndorsePnum='$eNum' and sangtae='1'";
	...
	for($j=0;$j<$mNum;$j++){
			...
			$update="UPDATE 2021DaeriMember  SET ";
