...
echo"<data>\n";
	...
	//퀵보드 증권번호 조회를 위하여 ...
	$certiSql="SELECT * FROM 2021CertiTable WHERE 2012DaeriCompanyNum='$num' and startyDay>='$yearbefore' order by InsuraneCompany desc";
...
$inWonTotal=0;//초기화
	...
	for($_m=0;$_m<$Rnum;$_m++)
	{
			...
			$f_date[$_m]=$rCertiRow[fstartyDay];  //증권별 받는날 
			if(!$f_date[$_m]){$f_date[$_m]=$fstart[2];}
		...
		echo "<sujeong".$_m.">"."수정".$f_date[$_m]."</sujeong".$_m.">\n";//
