...
<head>
	...
	<script src="./js/PreminumAjax.js" type="text/javascript"></script><!--ajax-->
...
<form>
	...
	<input type='hidden' id='userId' name='userId' value='<?=$userId?>'>
		<div id="preminumMain">
			   <div id="listPartP" ><? include "./php/daeriTablePreminum.php";?>	</div>
				<div id='sidebarP'><? include "./php/smsState.php";?></div>
				<div id='leftPremList'>
