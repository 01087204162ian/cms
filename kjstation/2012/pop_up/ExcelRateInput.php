...
<script type="text/javascript" src="./js/rate_gisa_execel.js"></script>
...
<body style="background:#fafafa;overflow-y:auto;" class="jui" >
...
<div class="wrap" id="wrap">
	...
	<div class="bau_blue_bar" id="bau_blue_bar"></div>
     ...
     <div id="excelUpload" >
		  ...
		  <input type='hidden' id='certiTableNum' value='<?=$num?>' />
