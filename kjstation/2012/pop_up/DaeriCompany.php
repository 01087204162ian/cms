			   ...
			   <div id="listPartCompany" >
					...
					<table>
					 ...
					 <tr>
						...
						<th width='10%' onMouseOver="this.style.backgroundColor='#EFF4F8'; style.cursor='hand'" onMouseOut="this.style.backgroundColor=''" onClick="ReadId()">읽기 전용 ID</th>
						<th width='10%'></th>
					...
					<tr>
						...
						<input type='button' id='qboard' class='btn-b' value='킥보드'  onclick="board()"/>
						</td>
					  </tr>
				</table>
			</div>
