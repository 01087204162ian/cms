<?//배서의 개수 부터 구하기 위해
	...
	$eSql="SELECT *  FROM 2021EndorseList WHERE pnum='$eNum' and CertiTableNum='$CertiTableNum'";
	//echo "eSql $eSql <br>";
	...
	$Dsql="SELECT * FROM 2021DaeriMember WHERE CertiTableNum='$CertiTableNum' and EndorsePnum='$eNum' and push='1' and InsuranceCompany='1'";
