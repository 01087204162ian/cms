...
<table>
	<tr>
		<td colspan='5'>[<?=$company?>]  년령별 보험료</td>
		<td colspan='3'> <?=$Inscompany?>화재 보험료 동일 <input type="checkbox" id="sameCheck" onclick='samePcheck(<?=$InsuraneCompany?>)'></td>
	</tr>
	<tr>
...
<!--	 <td><input type='text' class='textare<?=$cl?>' id='B5b<?=$_m?>' ></td>-->
 ...
 <!--  <tr>
	<?if($_m==0){?><td rowspan='3'>탁송</td><?}?>
	 ...
	 <td><input type='text' class='textare<?=$cl?>' id='C0b<?=$_m?>' onBlur="preminumCheck(this.id,this.value,<?=$_m?>,'2')" onClick="preminum(this.id,this.value)"/></td>
	 <td><input type='text' class='textare<?=$cl?>' id='C1b<?=$_m?>' ></td>
	 <td><input type='text' class='textare<?=$cl?>' id='C2b<?=$_m?>' ></td>
	 <td><input type='text' class='textare<?=$cl?>' id='C3b<?=$_m?>' ></td>
	 <td><input type='text' class='textare<?=$cl?>' id='C4b<?=$_m?>' ></td>
	 <td><input type='text' class='textare<?=$cl?>' id='C5b<?=$_m?>' ></td>
	 <td><input type='text' class='textare<?=$cl?>' id='C6b<?=$_m?>' ></td>
	 <td><input type='text' class='textare<?=$cl?>' id='c7b<?=$_m?>' ></td>
   ...
   <tr>
	 ...
	 <td><input type='text' class='textareP' id='in1won' ></td> <!-- 일반대리기사 합-->
	<!-- <td><input type='text' class='textareP' id='in2won' ></td> <!-- 탁송대리기사 합-->
	 <td><input type='text' class='textareP' id='in3won' ></td>
	 <td><input type='text' class='textareP' id='in4won' ></td>
   </tr>
 ...
 <?}?><!--업체 화면에서는 sele가 3이므로 노출 안됨-->
		...
		<!--	  <img class="calendar" src="../../../../sj/images/calendar.gif" onclick="displayCalendar(document.forms[0].sigi,'yyyy-mm-dd',this)"  />--></td>
			...
			<tr>
			  ...
			  <td><input type="text" name="p34p" id="p34p"   class='textareP' ></td>
		...
		<!--	<tr>
			...
			<tr>
			<td colspan='5' bgcolor="#ffffff" align='center'><input type="button" class="btn-b" style="cursor:hand;width:90;"  value="월보험료 입력"  onFocus='this.blur()' onClick="gijunDay()"></td>
	   ...
	   <table>
	   <tr>
			<th width='8%' rowspan='2'>일자</th>
			<th width='5%' rowspan='2'>경과일수</th>
			<th width='15%' colspan='3'>일반보험료</th>
		<!--	<th width='15%' colspan='3'>탁송보험료</th>-->
			<th width='8%' rowspan='2'>일자</th>
			<th width='5%' rowspan='2'>경과일수</th>
			<th width='15%' colspan='3'>일반보험료</th>
		<!--	<th width='15%' colspan='3'>탁송보험료</th>-->
		...
		<!--	<td align='right'><span id='p_day<?=$p?>'>&nbsp;</span></td>
			<td align='right'><span id='q_day<?=$p?>'>&nbsp;</span></td>
			<td align='right'><span id='r_day<?=$p?>'>&nbsp;</span></td>-->
		...
		<!--	<td align='right'><span id='p_day<?=$_p2?>'>&nbsp;</span></td>
			<td align='right'><span id='q_day<?=$_p2?>'>&nbsp;</span></td>
			<td align='right'><span id='r_day<?=$_p2?>'>&nbsp;</span></td>-->
		</tr>	
