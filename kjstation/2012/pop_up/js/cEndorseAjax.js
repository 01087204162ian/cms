	...
	if(myAjax.readyState == 4 && myAjax.status == 200) {
		...
		/*	for(var j=1;j<15;j++){
			...
			if(myAjax.responseXML.documentElement.getElementsByTagName("message")[0].text!=undefined){
				...
				//	document.getElementById('B9b'+_m).innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("dongbuCerti")[_m].text;//,표시 
					...
					sele(_m,myAjax.responseXML.documentElement.getElementsByTagName("sangtae")[_m].text,Cancel);
				...
				document.getElementById('insCom').innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("name8")[0].text;
				...
				{	document.getElementById('B1b'+_m).innerHTML=_m+1;
					...
					document.getElementById('B9b'+_m).innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("dongbuCerti")[_m].textContent;//,표시 
					...
					dongbuSele(_m,Push,Sangtae,Cancel);
					//alert(myAjax.responseXML.documentElement.getElementsByTagName("cancel"+_m)[0].textContent);
					//처리 미처리
					
					sele(_m,myAjax.responseXML.documentElement.getElementsByTagName("sangtae")[_m].textContent,Cancel);
					...
					if(eval(myAjax.responseXML.documentElement.getElementsByTagName("name14")[0].textContent==2)){
						...
						dongbuHaeji(_m,Push,Sangtae,Cancel,Certi,Serti,Sigi,Jeonggi,nabang_1);
					//	var Push=myAjax.responseXML.documentElement.getElementsByTagName("push"+_m)[0].textContent;
						if(Push==4 || Push==1){
						//document.getElementById('jang'+_m).value=;
						//document.getElementById('kang'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("dongbuSelNumber"+_m)[0].textContent;
						}
				...
				document.getElementById('insCom').innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("name8")[0].textContent;
				for(var _k=0;_k<eval(myAjax.responseXML.documentElement.getElementsByTagName("gaesu")[0].textContent);_k++)
				{
					...
					if(eval(myAjax.responseXML.documentElement.getElementsByTagName("get"+_k)[0].textContent)){
						get(_k,myAjax.responseXML.documentElement.getElementsByTagName("get"+_k)[0].textContent);
