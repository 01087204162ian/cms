...
function total_excel3(num){
		var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		var mstart=document.getElementById('sigi').value;
		var estart=document.getElementById('endm').value;
		//window.open('./sjExceltotal.php?num='+num,'excelTo','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');

		window.open('./listExcel3.php?num='+num+'&mstart='+mstart+'&estart='+estart,'excelTo2','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');
}

function total_excel2(num){
		//alert('1');

		
		var normalT = document.getElementById('normalT').checked;
		if(normalT){
		...
		window.open('./listExcel2.php?num='+num+'&mstart='+mstart+'&estart='+estart+'&normalT='+normalT,'excelTo2','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');
}


function kdriveExcelEndorse(num){
		//alert('1');

		
		var date = document.getElementById('endm').value;
		...
		window.open('./kdriveExcelEndorse.php?num='+num+'&mstart='+mstart+'&estart='+estart+'&date='+date,'kdriveExcelendorse','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');
}

function kdriveExcelEndorse2(num){
		//alert('1');
		...
		window.open('./kdriveEndorse2.php?num='+num+'&mstart='+mstart+'&estart='+estart+'&date='+date,'kdriveExcelendorse','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');
}
function kdriveExcel(num){
		//alert('1');
		...
		window.open('./kdriveExcel.php?num='+num+'&mstart='+mstart+'&estart='+estart+'&normalT='+normalT,'kdriveExcel','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');
}
...
function toCerti(){
	...
	var winl = (screen.width - 1024) / 2
		...
		window.open('../../kibs_admin/pdf/fpdf153/certi7.php?InsuraneCompany='+InsuraneCompany,'certiTo','left='+winl+',top='+wint+',resizable=yes,width=900,height=570,scrollbars=yes,status=yes');
