...
//alert(myAjax.responseXML.documentElement.getElementsByTagName("num")[0].text);
			if(myAjax.responseXML.documentElement.getElementsByTagName("message")[0].text!=undefined){
				...
				if(eval(myAjax.responseXML.documentElement.getElementsByTagName("store")[0].text)==1){
					...
					{	document.getElementById('B1b'+_m).innerHTML=_m+1;
						...
						document.getElementById('B0b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("certiNum"+_m)[0].text;
						document.getElementById('B3b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("startyDay"+_m)[0].text;
						document.getElementById('B4b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("policyNum"+_m)[0].text;
						
						//if(eval(myAjax.responseXML.documentElement.getElementsByTagName("InsuraneCompany"+_m)[0].text)!=2){
							//동부화재가 아닌 경우에 ...
						document.getElementById('B5b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("nabang"+_m)[0].text;
						cheriNab(_m,myAjax.responseXML.documentElement.getElementsByTagName("nabang_1"+_m)[0].text);
						switch(eval(myAjax.responseXML.documentElement.getElementsByTagName("naColor"+_m)[0].text)){
								case 1 : 
						...
						document.getElementById('B7b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("naState"+_m)[0].text;
						//}
						//인원을 조회하면 가상계좌,등을 조회할 수 있다
						MemberInwon(_m,myAjax.responseXML.documentElement.getElementsByTagName("inWon"+_m)[0].text);
						//document.getElementById('B8b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("inWon"+_m)[0].text;
						//
						jejang(_m,myAjax.responseXML.documentElement.getElementsByTagName("sujeong"+_m)[0].text);
						shin(_m,myAjax.responseXML.documentElement.getElementsByTagName("input"+_m)[0].text);//신규 입력
						unjun(_m,myAjax.responseXML.documentElement.getElementsByTagName("unjen"+_m)[0].text); //운전자 추가
						
						cfo(_m,myAjax.responseXML.documentElement.getElementsByTagName("diviCo"+_m)[0].text,myAjax.responseXML.documentElement.getElementsByTagName("divi"+_m)[0].text);//결제 방식
						prem(_m,myAjax.responseXML.documentElement.getElementsByTagName("moth"+_m)[0].text);//보험료 입력
						
						document.getElementById('B14b'+_m).value=myAjax.responseXML.documentElement.getElementsByTagName("moth"+_m)[0].text;
						//alert(myAjax.responseXML.documentElement.getElementsByTagName("b15"+_m)[0].text);
						charCter(_m,myAjax.responseXML.documentElement.getElementsByTagName("b15"+_m)[0].text);
						
					}
					for(var _n=eval(myAjax.responseXML.documentElement.getElementsByTagName("Rnum")[0].text);_n<9;_n++)
					{
				...
				//대리기사 인원 
				document.getElementById('tot').innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("inWonTotal")[0].text
				...
				// 메모 내용 저장을 위해 
				//alert(myAjax.responseXML.documentElement.getElementsByTagName("sNum")[0].text);

				/*if(myAjax.responseXML.documentElement.getElementsByTagName("sNum")[0].text>10){
					myAjax.responseXML.documentElement.getElementsByTagName("sNum")[0].text=10;
				}
				...
				if(myAjax.responseXML.documentElement.getElementsByTagName("content").length>=1){
					for(var v=0;v<myAjax.responseXML.documentElement.getElementsByTagName("content").length;v++)
					{
						...
						document.getElementById('m1_2').innerHTML+=myAjax.responseXML.documentElement.getElementsByTagName("content")[v].text+'\r\n';
...
function serch(val){
	...
	//alert(num);
	if(num){	
		var toSend = "./ajax/popBoardAjaxSerch.php?num="+num;
...
function post_p(){
	...
	myAjax=createAjax();
	var num=document.getElementById("num").value;
	var toSend = "./ajax/postc.php?num="+num
		...
		myAjax.open("get",toSend,true);
		myAjax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"); 
		myAjax.onreadystatechange=postReceive;
		myAjax.send('');
	...
	if(myAjax.readyState == 4 && myAjax.status == 200) {
		//alert(myAjax.responseText);
				...
				if(myAjax.responseXML.documentElement.getElementsByTagName("val")[0].text!=undefined){
					...
					document.getElementById('sql2').innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("sql")[0].textContent;
					var val=eval(myAjax.responseXML.documentElement.getElementsByTagName("val")[0].textContent);
				}
				//alert(val);
				if(myAjax.responseXML.documentElement.getElementsByTagName("name1")[0].text!=undefined){
					...
					document.getElementById('B0b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("num")[0].textContent;
					document.getElementById('B1b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name1")[0].textContent;
					//document.getElementById('B2b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name2")[0].textContent;
					document.getElementById('B3b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name3")[0].textContent;
					document.getElementById('B4b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name4")[0].textContent;
					//document.getElementById('B5b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name5")[0].textContent;
					document.getElementById('B6b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name6")[0].textContent;
					if(eval(myAjax.responseXML.documentElement.getElementsByTagName("name2")[0].textContent)!=2){
							//동부화재가 아닌 경우에 ...
						document.getElementById('B5b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name5")[0].textContent;
						cheriNab(val,myAjax.responseXML.documentElement.getElementsByTagName("name6")[0].textContent);
						switch(eval(myAjax.responseXML.documentElement.getElementsByTagName("naColor")[0].textContent)){
								case 1 : 
									document.getElementById('B7b'+val).style.color='#666666';
									break;
								case 2 :
						...
						document.getElementById('B7b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("naState")[0].textContent;
						}
					document.getElementById('B9b'+val).value=myAjax.responseXML.documentElement.getElementsByTagName("name32")[0].textContent;
...
function CertiStore(){
	...
	var a1=document.getElementById("DaeriCompanyNum").value;
	var certiNum=document.getElementById('B0b'+val).value;
	var a2=document.getElementById('sang'+val).options[document.getElementById('sang'+val).selectedIndex].value;
	...
	if(a2==2){//동부화재 인경우
		...
		var toSend = "./ajax/boardCertiAjax.php?a1="+a1
						+"&a2="+a2
					   +"&a3="+a3
						+"&a4="+a4
						+"&a5="+a5
...
function memberStore(){
	...
	if(certiNum){
	    var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		window.open('./boardDaeriMember.php?DaeriCompanyNum='+num+'&CertiTableNum='+certiNum+'&InsuraneCompany='+a2+'&policyNum='+a4,'preso22l','left='+winl+',top='+wint+',resizable=yes,width=640,height=600,scrollbars=no,status=yes')
	}else{
...
function memberEndorse(val){
	...
	if(certiNum){
	    var winl = (screen.width - 1024) / 2
		var wint = (screen.height - 768) / 2
		window.open('./boardMemberEndorse.php?DaeriCompanyNum='+num+'&CertiTableNum='+certiNum+'&InsuraneCompany='+a2+'&policyNum='+a4,'ppss','left='+winl+',top='+wint+',resizable=yes,width=640,height=600,scrollbars=no,status=yes')
	}else{
...
function divi(){
	...
	if(certiNum){
			if(confirm('결제방식을 변경합니다!!')){
				var toSend = "./ajax/boardDiviAjax.php?certiNum="+certiNum
								+"&val="+val;
...
function moth(){
	...
	if(certiNum){
		 var winl = (screen.width - 1024) / 2
				var wint = (screen.height - 768) / 2
				window.open('./boardNewPreminum.php?DaeriCompanyNum='+num+'&CertiTableNum='+certiNum+'&InsuraneCompany='+a2+'&policyNum='+a4,'cPre','left='+winl+',top='+wint+',resizable=yes,width=960,height=800,scrollbars=yes,status=yes')
		/*
		switch(eval(a2)){
			case 1 :
				 var winl = (screen.width - 1024) / 2
...
function daeriSerch(val){
    ...
    var winl = (screen.width - 1024) / 2
	var wint = (screen.height - 768) / 2
	window.open('./boardDaeriList.php?DaeriCompanyNum='+num+'&CertiTableNum='+certiNum+'&iNum='+a2,'memberList','left='+winl+',top='+wint+',resizable=yes,width=960,height=800,scrollbars=yes,status=yes')
	}else{
...
function daeriSerchAll(){
    ...
    var winl = (screen.width - 1024) / 2
	var wint = (screen.height - 768) / 2
	window.open('./daeriList.php?DaeriCompanyNum='+num,'allDriverMember11','left='+winl+',top='+wint+',resizable=yes,width=1024,height=800,scrollbars=yes,status=yes')
	}else{
...
function board(){
    ...
    var winl = (screen.width - 1024) / 2
	var wint = (screen.height - 768) / 2
	window.open('./qboard.php?DaeriCompanyNum='+num,'qboard.php','left='+winl+',top='+wint+',resizable=yes,width=1024,height=800,scrollbars=yes,status=yes')
	}else{
