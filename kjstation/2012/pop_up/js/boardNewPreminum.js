...
function serch(val){
	...
	//alert(InsuraneCompany);
			...
			var toSend = "./ajax/boardNewPreminumSerch.php?CertiTableNum="+num//CertiTableNum
...
function naiCheck(id,val,sunso){
	...
	if(!val){
		...
		for(j=0;j<sunso;j++){
			...
			var toSend = "./ajax/boardNaiInput.php?CertiTableNum="+num//CertiTableNum
	...
	if(val>=1){
		if(confirm('보험료 입력합니다!!')){
			...
			document.getElementById('B10b'+sunso).value='';
				...
				var toSend = "./ajax/boardYearInput.php?CertiTableNum="+num//CertiTableNum
							+"&InsuraneCompany="+InsuraneCompany
							+"&DaeriCompanyNum="+DaeriCompanyNum
							+"&preminum="+val
							+"&sunso="+sunso
...
function monthCheck(id,val,sunso){
	...
	if(confirm('월보험료 입력합니다!!')){
			...
			var sP=document.getElementById('B0b'+sunso).value;
			var eP=document.getElementById('B1b'+sunso).value;
			var toSend = "./ajax/boardMonthInput.php?CertiTableNum="+num//CertiTableNum
						+"&InsuraneCompany="+InsuraneCompany
						+"&DaeriCompanyNum="+DaeriCompanyNum
						+"&preminum="+val
						+"&sunso="+sunso
