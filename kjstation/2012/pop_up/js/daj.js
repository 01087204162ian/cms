...
function call(){ //진행상황에 
	...
	var toSend = "../dajoong/ajax/call.php?num="+num
				   +"&val="+this.value
				  // +"&end="+end
				  // +"&page="+page;
	//alert(toSend)
...
if(this.value.length>1){
	...
	var toSend = "./ajax/faxInput.php?num="+num
				 +"&fax="+this.value;
...
function changeChC(){
	...
	var toSend = "./ajax/chInput.php?num="+num
				 +"&ch="+ch;
...
switch(inSNum){
	...
	var toSend = "./ajax/certiInput.php?num="+num
				 +"&certi="+this.value;
...
function prem(){
	...
	var toSend = "./ajax/preminumChange.php?num="+num
				 +"&preminum="+this.value;
...
switch(inSNum){
	...
	var toSend = "./ajax/selNumChange.php?num="+num
				 +"&inSNum="+inSNum
				 +"&selNum="+this.value;
...
function inputD(){
	...
	if(document.getElementById('inputDay').checked==true){
		...
		var toSend = "./ajax/inPutDay.php?num="+num
					 +"&Did="+D1d;
...
function virtual(){
	...
	var toSend = "./ajax/virtualChange.php?num="+num
				 +"&virtual="+this.value;
...
function changeBank(){//은행명 변경 
	...
	var toSend = "./ajax/bankChange.php?num="+num
				 +"&BankName="+BankName;
...
function changeCom(){
	...
	var toSend = "./ajax/changeCompany.php?num="+num
				 +"&com="+this.value;
		//alert(toSend)			 
	myAjax.open("get",toSend,true);
	myAjax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"); 
...
function serch(val){
	...
	var num=document.getElementById('num').value;
	//var CertiTableNum=document.getElementById('CertiTableNum').value;
	var toSend = "./ajax/dajSerch.php?num="+num
...
function store(){
	...
	if(confirm(mess)){
		var toSend = "./ajax/dajoongAjax.php?a1="+a1
					   +"&a2="+a2
					   +"&a3="+a3
					   +"&a4="+a4
					   +"&a16="+a16
