...
//alert(myAjax.responseText);
		if(myAjax.responseXML.documentElement.getElementsByTagName("message")[0].text!=undefined){
			alert(myAjax.responseXML.documentElement.getElementsByTagName("message")[0].text);
				...
				document.getElementById('B7b'+j).value=myAjax.responseXML.documentElement.getElementsByTagName("daily"+j)[0].text;//일보험료
	...
	//
			...
			if(myAjax.responseXML.documentElement.getElementsByTagName("Insurane")[0].textContent==7){
				...
				document.getElementById('B7b'+j).value=myAjax.responseXML.documentElement.getElementsByTagName("daily"+j)[0].textContent;//일보험료
...
function serch(val){
	...
	//alert(InsuraneCompany);
			...
			var toSend = "./ajax/newPreminumSerch.php?CertiTableNum="+num//CertiTableNum
	...
	if(myAjax.readyState == 4 && myAjax.status == 200) {
       //alert(myAjax.responseText);
		if(myAjax.responseXML.documentElement.getElementsByTagName("message")[0].text!=undefined){
			...
			document.getElementById('B7b'+sunso).value=myAjax.responseXML.documentElement.getElementsByTagName("preminum10")[0].text;
				//document.getElementById('A1a').innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("InsuraneCompany")[0].text;
				//document.getElementById('A2a').innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("DaeriCompanyNum")[0].text;
			...
			document.getElementById('B7b'+sunso).value=myAjax.responseXML.documentElement.getElementsByTagName("preminum10")[0].textContent;
...
function dailyCheck(id,val,sunso){
	...
	if(val>=1){
		if(confirm('보험료 입력합니다!!')){
				...
				var sP=document.getElementById('B0b'+sunso).value;
				var eP=document.getElementById('B1b'+sunso).value;
				var toSend = "./ajax/dailyInput.php?CertiTableNum="+num//CertiTableNum
							+"&InsuraneCompany="+InsuraneCompany
							+"&DaeriCompanyNum="+DaeriCompanyNum
							+"&preminum="+val
							+"&sunso="+sunso
