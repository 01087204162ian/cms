...
<head>
	...
	<script src="./js/jungbok.js" type="text/javascript"></script><!--ajax-->
...
<form>
	<input type='hidden' id='jumin' value='<?=$jumin?>' />
		...
		<div id="SjPopUpMain111">
		  
			 
	
			<div id="listPartjungbok" >
					  <input type='hidden' id='page' />
					<table>
					 <caption>기사리스트</caption>
					  <thead>
					  <tr>
						<td width='3%'>번호</td>
						<td width='9%'>성명</td>
					...
					<? for($j=0;$j<20;$j++){?>
					 <tr>
						...
						<td><span id='A5a<?=$j?>'>&nbsp;</span></td>
						<td><span id='A6a<?=$j?>'>&nbsp;</span><input type='hidden' id='cNum<?=$j?>'></td><!--대리컴퍼티-->
						<td><span id='A8a<?=$j?>'>&nbsp;</span></td><!--보힘회사-->
						<td onMouseOver="this.style.backgroundColor='#EFF4F8'; style.cursor='hand'" onMouseOut="this.style.backgroundColor=''">
						<span id='A9a<?=$j?>' >&nbsp;</span><input type='hidden' id='iNum<?=$j?>'></td><!--증권번호-->
						<td><span id='A29a<?=$j?>'>&nbsp;</span></td>
						<td><span id='A10a<?=$j?>'>&nbsp;</span></td>
						
						<td><span id='A11a<?=$j?>'>&nbsp;</span><input type='hidden' id='pNum<?=$j?>'></td><!---->
						<td onMouseOver="this.style.backgroundColor='#EFF4F8'; style.cursor='hand'" onMouseOut="this.style.backgroundColor=''"><span id='A13a<?=$j?>'>&nbsp;</span></td><!---->
