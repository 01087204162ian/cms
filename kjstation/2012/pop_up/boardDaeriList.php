...
<head>
	...
	<script src="./js/boardDaeriList.js" type="text/javascript"></script><!--ajax-->
	<script src="/2012c/js/common_tong.js" type="text/javascript"></script><!--인증관련-->
</head>
<? $sql="SELECT distinct(InsuraneCompany) FROM  2021CertiTable  WHERE  2012DaeriCompanyNum='$DaeriCompanyNum' and startyDay>='$yearbefore' ";
//echo "Sql $sql <br>";
