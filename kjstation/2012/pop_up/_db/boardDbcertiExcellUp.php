		...
		if($proc == "rateExcell") { //증권번호를 update 하기 위해
			...
			for ($i = 2; $i <= $data->sheets[0]['numRows']; $i++) {
					...
					echo("\t<policy>\n");
						...
						$sql="SELECT * FROM 2021DaeriMember WHERE CertiTableNum='$policy' and jumin='$jumin' and push='4'";
						...
						if($row[num]){
							...
							$update = "UPDATE 2021DaeriMember SET dongbuCerti='$dongbuCerti' WHERE num='$row[num]'";
			...
			$c_sql="SELECT * FROM 2021CertiTable WHERE num='$policy'";
			...
			for ($i = 2; $i <= $data->sheets[0]['numRows']; $i++) {
					...
					echo("\t<policy>\n");
					    ...
					    $insert="INSERT into 2021DaeriMember (moCertiNum,2012DaeriCompanyNum,InsuranceCompany,CertiTableNum,Name,Jumin,nai,push,etag,FirstStart, ";
