...
<head>
	...
	<script src="./js/boardDaeriMember.js" type="text/javascript"></script><!--ajax-->
...
<form>
	...
	<input type='hidden' id='policyNum' value='<?=$policyNum?>' />
		<div id="newUnjeon">
					...
					<tr>
						<td colspan='5'><span id='company' /></td>
						<td><input type="button" class="btn-b" style="cursor:hand;width:80;"  value="신규Excel"  onFocus='this.blur()' onClick="newInsert()"></td>
					 </tr>
			         <tr>
						<th width='5%'>순번</th>
						<th width='15%'>성명</th>
					 ...
					 <tr>
						...
						<td><input type='text' class='textare<?=$cl?>' id='a6b<?=$i?>'  </td>
				...
				<table>
					<tr>
						<td>&nbsp;<span id='a35'  />&nbsp;</span>
						<input type='button' id='a32' class='btn-b' value='저장'  onMouseOver="this.style.backgroundColor='#EFF4F8'; style.cursor='hand'" onMouseOut="this.style.backgroundColor=''" onclick="store(1)">
						<input type='hidden' id='test' value='' /></td>
					  </tr>
				</table>
