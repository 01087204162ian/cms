...
$sql="SELECT  *  FROM 2012DaeriMember a left join 2012DaeriCompany  b ON a.2012DaeriCompanyNum = b.num  ";	$sql.="WHERE a.sangtae='1'     and a.dongbuCerti='$certi'  and a.push='1' ";
...
for ($i = 0; $i <$eCount; $i++) {
   ...
   $EXCEL_STR .= "  
   <tr >  
       <td colspan='9' style=\"text-align:center;mso-number-format:'\@';\">"."청약리스트 입니다"."</td>  
