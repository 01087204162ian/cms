...
if(sumTotal>0){
				...
				for(var k=0;k<myAjax.responseXML.documentElement.getElementsByTagName("a1").length;k++){
					...
					if(myAjax.responseXML.documentElement.getElementsByTagName("a1")[k].text!=undefined){
						...
						document.getElementById('A12a'+k).innerHTML=myAjax.responseXML.documentElement.getElementsByTagName("a12")[k].textContent;
						...
						document.getElementById('A7a'+k).value=myAjax.responseXML.documentElement.getElementsByTagName("a7")[k].textContent;
						...
						document.getElementById('cNum'+k).value=myAjax.responseXML.documentElement.getElementsByTagName("cNum")[k].textContent;
						//(k);
...
function daeriSerch(){
	...
	window.open('../pop_up/daeriList.php?DaeriCompanyNum='+num+'&CertiTableNum='+certiNum+'&iNum='+iNum,'memberList','left='+winl+',top='+wint+',resizable=yes,width=1100,height=800,scrollbars=yes,status=yes')
}
/*
