...
include '../../../dbcon.php';
	...
	if($s_contents){
		...
		$where="where Rphone1='$Rphone[0]' and Rphone2='$Rphone[1]' and Rphone3='$Rphone[2]'  and SendName='gaplus' order by SeqNo desc";
	}else{
		$where="WHERE LastTime>='$sigi' and LastTime<='$end' and SendName='gaplus' order by SeqNo desc";
	}
